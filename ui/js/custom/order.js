...
$("#saveOrder").on("click", function () {
    ...
    var isFormValid = true; // Flag to check form validity
    ...
    for (var i = 0; i < formData.length; ++i) {
        ...
        switch (element.name) {
            case 'customerName':
                ...
                // Validate if the customer name is not empty
                if (!requestPayload.customer_name.trim()) {
                    alert("Customer Name is required!");
                    $("#customerName").addClass("highlight-error");
                    $("#customerName").removeClass("form-control");
                    isFormValid = false;
                } else {
                    $("#customerName").removeClass("highlight-error");
